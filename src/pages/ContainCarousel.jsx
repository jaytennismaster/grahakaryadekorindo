...
const ContainCarousel = ({ images, location, judul }) => {
  return (
          ...
          {images.map((src, index) => (
            ...
            >
              <img
                src={src}
                alt={`Slide ${index + 1}`}
                className="w-full h-auto max-h-[full] aspect-video object-contain object-center shadow-lg"
                loading="lazy"
              />
            </SwiperSlide>
          ))}
...
export default ContainCarousel;
